                ...
                <div className="modal-content">
                    ...
                    <div className="modal-footer center-content">
                        <button
                            ...
                            className="btn-limpiar btn-firma-disable" type="button"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                       className="icon icon-tabler icon-tabler-device-mobile-message" width="24" height="24"
                                                                                       viewBox="0 0 24 24" strokeWidth="2" stroke="#000000" fill="none"
                        ...
                        <button 
                        onClick={verifyOtp}
                        className="btn-firma btn-firma-disable" type="button"> Validar Código<svg
                            xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevrons-right"
                            width="24" height="24" viewBox="0 0 24 24" strokeWidth="3" stroke="#ffffff" fill="none"
                            strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
